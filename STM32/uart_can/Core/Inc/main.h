...
#define SNSOUT_Pin GPIO_PIN_3
#define SNSOUT_GPIO_Port GPIOA
#define nFAULT_Pin GPIO_PIN_4
#define nFAULT_GPIO_Port GPIOA
#define CAN_S_Pin GPIO_PIN_5
#define CAN_S_GPIO_Port GPIOA
#define CurentMeasurement_Pin GPIO_PIN_0
#define CurentMeasurement_GPIO_Port GPIOB
#define ENDSTOP_Pin GPIO_PIN_2
#define ENDSTOP_GPIO_Port GPIOB
#define ENDSTOP2_Pin GPIO_PIN_12
#define ENDSTOP2_GPIO_Port GPIOA
