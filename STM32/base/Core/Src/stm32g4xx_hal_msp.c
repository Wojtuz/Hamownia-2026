...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    PB13     ------> ADC3_IN5
    */
    GPIO_InitStruct.Pin = NTC1_ADC_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(NTC1_ADC_GPIO_Port, &GPIO_InitStruct);
  ...
  */
    ...
    PB12     ------> ADC4_IN3
    */
    GPIO_InitStruct.Pin = NTC2_ADC_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(NTC2_ADC_GPIO_Port, &GPIO_InitStruct);
  ...
  */
    ...
    PA8     ------> ADC5_IN1
    */
    GPIO_InitStruct.Pin = Chopper_ADC_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(Chopper_ADC_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC3)
  {
    ...
    PB13     ------> ADC3_IN5
    */
    HAL_GPIO_DeInit(NTC1_ADC_GPIO_Port, NTC1_ADC_Pin);
  ...
  else if(hadc->Instance==ADC4)
  {
    ...
    PB12     ------> ADC4_IN3
    */
    HAL_GPIO_DeInit(NTC2_ADC_GPIO_Port, NTC2_ADC_Pin);
  ...
  else if(hadc->Instance==ADC5)
  {
    ...
    PA8     ------> ADC5_IN1
    */
    HAL_GPIO_DeInit(Chopper_ADC_GPIO_Port, Chopper_ADC_Pin);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  if(htim->Instance==TIM3)
  {
    ...
    PC9     ------> TIM3_CH4
    */
    GPIO_InitStruct.Pin = Chopper_PWM_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM3;
    HAL_GPIO_Init(Chopper_PWM_GPIO_Port, &GPIO_InitStruct);
