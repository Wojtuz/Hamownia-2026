...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, EEP_WP_Pin|INDICATOR_YELLOW_Pin|INDICATOR_RED_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, LIN_EN_Pin|SPI1_CS1_Pin|LED_ER_Pin|LED_OK_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, SPI1_CSS2_Pin|INDICATOR_GREEN_Pin|RS485_RX_TX_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : IMU_INT1_Pin IMU_INT2_Pin Chopper__OV_Pin */
  GPIO_InitStruct.Pin = IMU_INT1_Pin|IMU_INT2_Pin|Chopper__OV_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pins : EEP_WP_Pin INDICATOR_YELLOW_Pin INDICATOR_RED_Pin */
  GPIO_InitStruct.Pin = EEP_WP_Pin|INDICATOR_YELLOW_Pin|INDICATOR_RED_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pins : LIN_EN_Pin SPI1_CS1_Pin LED_ER_Pin LED_OK_Pin */
  GPIO_InitStruct.Pin = LIN_EN_Pin|SPI1_CS1_Pin|LED_ER_Pin|LED_OK_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : SPI1_CSS2_Pin INDICATOR_GREEN_Pin RS485_RX_TX_Pin */
  GPIO_InitStruct.Pin = SPI1_CSS2_Pin|INDICATOR_GREEN_Pin|RS485_RX_TX_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : INA2_ALERT_Pin INA1_ALERT_Pin */
  GPIO_InitStruct.Pin = INA2_ALERT_Pin|INA1_ALERT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
